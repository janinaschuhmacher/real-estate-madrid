...
class TestEncodeApiCredentials(unittest.TestCase):
    ...
    def test_encode_api_credentials(self):
        test_base64_authorization_string = encode_api_credentials(api_key=self.api_key, secret=self.secret)
...
class TestGetBearerAccessToken(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.mock_encode_api_credentials_patcher = patch("functions.get_bearer_access_token.encode_api_credentials")
        cls.mock_encode_api_credentials = cls.mock_encode_api_credentials_patcher.start()
    ...
    def test_get_bearer_access_token(self):
        ...
        test_response = get_bearer_access_token(base64_authorization_string="authorization_string")
